export const nl = {
  ...
  home: {
    ...
    recentGroundsTitle: "Recente Grounds",
    recentGroundsSubtitle: "Laatst bezochte stadions en wedstrijdverslagen",
    viewAllGrounds: "Bekijk Alle Grounds →",
    featuredScarvesTitle: "Uitgelichte Sjaals",
    featuredScarvesSubtitle: "Een greep uit de sjaalcollectie",
