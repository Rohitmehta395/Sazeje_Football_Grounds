...
export const About: GlobalConfig = {
  ...
  fields: [
    ...
    },
    {
      name: 'pillars',
      type: 'array',
      label: 'Groundhopping Core Values / Pillars',
      admin: {
        description: 'Core principles of SaZeJe Groundhopping (up to 3 or 4 cards)',
      },
      fields: [
        {
          type: 'row',
          fields: [
            {
              ...
              admin: {
                width: '50%',
                description: 'Pillar title (Dutch)',
              },
            },
            {
              name: 'titleEn',
              ...
              admin: {
                width: '50%',
                description: 'Pillar title (English)',
              },
            },
          ],
        },
          ...
          fields: [
            {
              ...
              admin: {
                width: '50%',
                description: 'Pillar description (Dutch)',
              },
            },
            {
              name: 'descriptionEn',
              ...
              admin: {
                width: '50%',
                description: 'Pillar description (English)',
              },
            },
          ],
        },
